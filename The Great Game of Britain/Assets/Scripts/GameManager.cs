...
public class GameManager : MonoBehaviour
{
	...
	void Start()
	{
        ...
        players[currentplayer].GetComponent<PlayerController>().isControllerEnabled = true;
         ...
         helpSystem = GameObject.Find("HelpMsgSystem");
    }
	...
	public void rollDice()
	{
        ...
        {
            helpSystem.GetComponent<Text>().text = "you have already rolled this turn";
        }
    }
	...
	{
        StartCoroutine(ReturnToMenu(playerWhoWon, GameObject.Find("Status_Text").GetComponent<Text>()));
	}
	...
	public void setBlocker()
	{
		...
		cardDisplay.setCard(currentcards);
		cardDisplay.updateCard();
		Debug.Log("updating the cards");
		mainCanvas.transform.Find("TextSelection").GetComponent<Text>().text = ("Selected: ");
		mainCanvas.transform.Find("TextMovePermission").GetComponent<Text>().text = ("Accessible: ");
        }
        else
        {
            Debug.Log("You need to place 2 blockers on the board");
        }
        #endregion
    }
